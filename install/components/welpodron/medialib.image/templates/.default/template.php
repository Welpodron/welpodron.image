...
<? if ($arResult) : ?>
    <picture>
        ...
        if ($arParams['AVIF_USE']) {
            echo Converter::getAvifSource($arResult['FILE_PATH'], $arParams['AVIF_QUALITY'], $arParams['LAZY_USE']);
        }
        ?>
        <?
        if ($arParams['WEBP_USE']) {
            echo Converter::getWebpSource($arResult['FILE_PATH'], $arParams['WEBP_QUALITY'], $arParams['LAZY_USE']);
        }
        ?>
